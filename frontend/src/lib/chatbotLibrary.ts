...
export const STARTER_CHATBOT_LIBRARY: ChatbotLibraryItem[] = [
  ...
  },
  {
    ...
    description:
      "Note de cadrage deja appliquee par le chatbot: FLARE AI a de l'experience sur le livestream multicamera, mais aucune preuve video n'est encore prete ici.",
    ...
    content: [
      ...
      "Message autorise: FLARE AI en a deja realise plusieurs parmi plus de 300 projets et peut orienter vers un devis rapide.",
    ].join("\n\n"),
  },
  {
    id: "enterprise-company-profile",
    category: "enterprise",
    title: "FLARE AI - Presentation entreprise",
    documentTitle: "FLARE AI - Presentation entreprise",
    description:
      "Base courte sur l'activite, les services principaux et le positionnement commercial de FLARE AI.",
    sourceLabel: "Synthese depuis le direct service",
    keywords: ["entreprise", "presentation", "a propos", "services", "mission"],
    importMode: "text",
    content: [
      "FLARE AI est un studio de production et d'automatisation commerciale.",
      ...
      "FLARE AI a deja realise plus de 300 projets selon le cadrage commercial du chatbot.",
  ...
  },
  {
    ...
    category: "enterprise",
    title: "FLARE AI - Flow commercial Messenger",
    documentTitle: "FLARE AI - Flow commercial Messenger",
    description:
    ...
    content: [
      ...
      "Quand le cas est urgent, complexe, sensible ou litigieux: basculer vers une reprise humaine FLARE AI.",
    ].join("\n\n"),
  },
];
