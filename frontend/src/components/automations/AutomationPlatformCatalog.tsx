...
function TikTokLogo() {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" aria-hidden>
      <path fill="#FE2C55" d="M15.19 2.1c.33 1.86 1.54 3.27 3.36 3.44v2.32a6.08 6.08 0 01-3.28-1v6.64c0 3.36-2.08 5.55-5.28 5.55-3.06 0-5.36-2.09-5.36-5.13 0-3.3 2.6-5.33 5.84-5.01v2.52c-1.61-.21-3.12.6-3.12 2.31 0 1.52 1.1 2.37 2.53 2.37 1.51 0 2.6-.95 2.6-2.82V2.1h2.71z" />
      <path fill="#25F4EE" d="M14.97 5.92a6.08 6.08 0 003.28 1V4.6c-.25-.03-.48-.07-.7-.14v1.8a6.08 6.08 0 01-3.28-1v6.64c0 3.36-2.08 5.55-5.28 5.55-.57 0-1.1-.07-1.61-.22a5.12 5.12 0 002.31.49c3.2 0 5.28-2.19 5.28-5.55V5.92z" />
      <path fill="#FFFFFF" d="M14.97 1c.35 1.96 1.54 3.39 3.53 3.62v2.56a6.35 6.35 0 01-3.44-1.04v7.03c0 3.55-2.15 5.83-5.49 5.83-3.18 0-5.57-2.2-5.57-5.4 0-3.45 2.74-5.56 6.07-5.22v2.68c-1.68-.22-3.25.62-3.25 2.42 0 1.6 1.16 2.49 2.63 2.49 1.57 0 2.7-1 2.7-2.96V1h2.82z" />
    </svg>
  );
}
