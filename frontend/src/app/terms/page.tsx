...
export const metadata: Metadata = {
  ...
  description: "Conditions générales d'utilisation de FLARE AI par RAM'S FLARE.",
};
    ...
    >
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "60px 32px 80px" }}>
        ...
        {[
          ...
          { title: "2. Description du service", content: "FLARE AI est une plateforme d'intelligence artificielle permettant aux entreprises de gérer un chatbot Messenger, un assistant IA, des campagnes de prospection et du contenu marketing. Le service est fourni par RAM'S FLARE." },
          ...
          { title: "6. Propriété intellectuelle", content: "Le contenu, le code et les marques de FLARE AI appartiennent à RAM'S FLARE. Le contenu que vous créez via notre plateforme vous appartient. Vous accordez à RAM'S FLARE une licence limitée pour traiter ce contenu afin de fournir le service." },
          { title: "7. Limitation de responsabilité", content: "FLARE AI est fourni « en l'état ». RAM'S FLARE ne peut être tenu responsable des dommages indirects ou des pertes résultant de l'utilisation du service, des interruptions de service, ou des réponses générées par l'IA." },
          { title: "8. Résiliation", content: "Vous pouvez résilier votre compte à tout moment. RAM'S FLARE se réserve le droit de suspendre ou résilier les comptes en cas de violation des présentes conditions." },
          { title: "9. Contact", content: "Pour toute question : RAM'S FLARE — contact@ramsflare.com — ramsflare.com" },
        ].map((section, i) => (
