# CODE REVIEW REQUEST: TKT-009
**Auteur**: BETA
**Date**: 2026-03-21T11:15:09.500Z

## Changements

### NOUVEAU FICHIER : backend/routers/billing.py
```
"""
...
class CreateCheckoutSessionRequest(BaseModel):
    plan_id: str
    # Le frontend peut spécifier des URLs de succès/annulation
    success_url: str
    cancel_url: str
...
def create_portal_session(
    ...
    try:
        portal_session = stripe.billing_portal.Session.create(
            ...
            return_url=settings.FRONTEND_URL, # URL de retour après la session
        )
...
2. Si c'est parfait, tape: `node flare_review.js approve TKT-009`
3. S'il y a des erreurs, tape: `node flare_review.js reject TKT-009 "Tes explications..."`
